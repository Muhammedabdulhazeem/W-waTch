...
const LikeCartIcon = () => {
    ...
    return (
        <div className="like-cart">
            ...
            <div onClick={() => {setFillCart(!fillCart)}} className="cart-icon">
                <svg class="w-6 h-6" fill={fillCart? color : 'white'} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
